...
from girder.plugins.minerva.rest import \
        ...
        bsve_search_source, bsve_search_dataset
...
def load(info):
    ...
    info['apiRoot'].minerva_source_bsve = bsve_search_source.BSVESearchSource()
    info['apiRoot'].minerva_dataset_bsve = bsve_search_dataset.BSVESearchDataset()
